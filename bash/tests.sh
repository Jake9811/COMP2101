...
[ /etc/hosts -nt /etc/resolv.conf -a /etc/hosts -nt /tmp ] && echo "/etc/hosts is newest"
[ /etc/hosts -ot /etc/resolv.conf -a /tmp -ot /etc/resolv.conf ] && echo "/etc/resolv.conf is newest"
[ /tmp -nt /etc/hosts -a /tmp -nt /etc/resolv.conf ] && echo "/tmp is newest"
[ ! /etc/hosts -nt /etc/resolv.conf -a ! /etc/hosts -ot /etc/resolv.conf -a ! /tmp -nt /etc/hosts -a ! /tmp -ot /etc/hosts ] && echo "/etc/hosts, /etc/resolv.conf, /tmp are the same age"
...
[ $(( $secondNumber % $firstNumber )) -eq 0 ] && echo "The second number is a multiple of first number"
...
[ -n USER ] && echo "The USER variable contains the username of the currently logged on user"
[ -z USER ] && echo "The variable USER is empty"
